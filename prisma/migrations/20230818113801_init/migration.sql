...
CREATE TABLE "faculites" (
    ...
    CONSTRAINT "faculites_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "faculites" ADD CONSTRAINT "faculites_academicDepartmentId_fkey" FOREIGN KEY ("academicDepartmentId") REFERENCES "academic_departments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "faculites" ADD CONSTRAINT "faculites_academicFacultyId_fkey" FOREIGN KEY ("academicFacultyId") REFERENCES "academic_faculties"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
